...
pub fn cswap_always_correct(n: HanInt, x: &mut [f32], incx: HanInt, y: &mut [f32], incy: HanInt) {
...
pub fn zswap_always_correct(n: HanInt, x: &mut [f32], incx: HanInt, y: &mut [f32], incy: HanInt) {
